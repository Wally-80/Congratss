...
- Integrate with Firebase for real-time data and authentication.
- Ensure the application is responsive and user-friendly.

## Roadmap
- [x] Initial setup and project bootstrapping.
- [x] Firebase integration.
- [x] Celebration management UI.
- [/] Project migration out of OneDrive.
