            ...
            <div className="glass w-full max-w-sm rounded-[3rem] p-10 shadow-2xl text-center space-y-8 animate-in fade-in zoom-in duration-700">
                <div className="flex flex-col items-center gap-4">
                    ...
                    <div className="flex flex-col items-center">
                        <h1 className="text-4xl font-black tracking-tighter italic mb-1">Congratss</h1>
                        <p className="text-xs font-bold uppercase tracking-[0.3em] text-muted-foreground mt-6">{t.welcome_back}</p>
                    </div>
                </div>
