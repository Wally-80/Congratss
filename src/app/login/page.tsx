            ...
            <div className="glass w-full max-w-sm rounded-[3rem] p-10 shadow-2xl text-center space-y-8 animate-in fade-in zoom-in duration-700">
                <div className="flex flex-col items-center gap-12">
                    ...
                    <div className="flex flex-col items-center">
                        <h1 className="text-5xl font-black tracking-tighter italic">Congratss</h1>
                        <p className="text-xs font-bold uppercase tracking-[0.4em] text-muted-foreground mt-12">{t.welcome_back}</p>
                    </div>
                </div>
